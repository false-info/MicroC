head(custom) {
    ...
    fn emit_mem_read16_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0x48)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x0F)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0xB7)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x00)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_mem_read32_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0x8B)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_mem_write16_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0x66)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x89)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x07)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_addr_var(I64 index) {
        ...
        os_file_write8(mem_read64(0x800008), 0x8D)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x85)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), displacement & 255)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_port_in8_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0xC2)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x31)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0xC0)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0xEC)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_port_in16_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0xED)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_port_out8_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0xEE)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_port_out16_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0xEF)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_read_cr0_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0x20)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_write_cr0_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0x22)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_read_cr2_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0xD0)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_read_cr3_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0xD8)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_read_cr4_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0xE0)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_invlpg_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0x01)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x38)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_lgdt_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0x10)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_lidt_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0x18)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_rdmsr_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0xC1)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x0F)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x32)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
        ...
        os_file_write8(mem_read64(0x800008), 0xE2)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 32)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x48)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x09)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpu_wrmsr_code() {
        ...
        os_file_write8(mem_read64(0x800008), 0xEA)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
        ...
        os_file_write8(mem_read64(0x800008), 0x30)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
    ...
    fn emit_cpuid_result_code(I64 which) {
        ...
        os_file_write8(mem_read64(0x800008), 0x53)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0x0F)
        mem_write64(0x800090, mem_read64(0x800090) + 1)

        os_file_write8(mem_read64(0x800008), 0xA2)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
        ...
        if (which == 2) {
            ...
            os_file_write8(mem_read64(0x800008), 0xC8)
            mem_write64(0x800090, mem_read64(0x800090) + 1)
        }
        ...
        os_file_write8(mem_read64(0x800008), 0x5B)
        mem_write64(0x800090, mem_read64(0x800090) + 1)
        ...
        while (running != 0) {
            ...
            if (running != 0) {
                ...
                if (running != 0) {
                    ...
                    current_type = emit_binary_typed(
                        op,
                        current_type,
                        right_type
                    )
    ...
    fn parse_builtin_call(I64 id) {
        ...
        if (id == 28) {
            parse_expression(0)
            expect_sym(41)
            emit_cpu_write_cr0_code()
            return 8
        }

        if (id == 29) {
            expect_sym(41)
            emit_cpu_read_cr2_code()
            return 8
        }

        if (id == 30) {
            expect_sym(41)
            emit_cpu_read_cr3_code()
            return 8
        }
        ...
        if (id == 31) {
            parse_expression(0)
            expect_sym(41)
            emit_cpu_write_cr3_code()
            return 8
        }

        if (id == 32) {
            expect_sym(41)
            emit_cpu_read_cr4_code()
            return 8
        }
    ...
    fn parse_inline_asm() {
        ...
        while (done == 0) {
            ...
            if (done == 0) {
                ...
                if (tok_is("rdtscp") != 0) {
                    handled = 1
                    asm_put3(0x0F, 0x01, 0xF9)
                }

                if (tok_is("xgetbv") != 0) {
                    handled = 1
                    asm_put3(0x0F, 0x01, 0xD0)
                }

                if (tok_is("xsetbv") != 0) {
                    handled = 1
                    asm_put3(0x0F, 0x01, 0xD1)
                }
    ...
    fn parse_function() {
        ...
        while (i < params) {
            I64 param_index = mem_read64(
                0x800400 + i * 16
            )

            I64 param_type2 = mem_read64(
                0x800408 + i * 16
            )

            emit_store_arg_typed(
                param_index,
                i,
                param_type2
            )
    ...
    fn compiler_main() {
        ...
        if (count < 2) {
            os_write("MicroC\n")
            os_write("mcc source.mc -o program\n")
            os_write("mcc -aot source.mc -o program\n")
            os_write("mcc -jit source.mc\n")
            os_write("mcc -raw source.mc -o program.bin\n")
        ...
        if (strcmp(first, "-aot") == 0) {
            if (count != 5) {
                os_write("usage: mcc -aot source.mc -o program\n")
                return 1
            }
        ...
        if (strcmp(first, "-raw") == 0) {
            if (count != 5) {
                os_write("usage: mcc -raw source.mc -o program.bin\n")
                return 1
            }
            ...
            if (ends_program_bin(os_argv(4)) == 0) {
                os_write("raw output must end in .bin or .BIN\n")
                return 1
            }
        ...
        if (strcmp(first, "-trusted") == 0) {
            ...
            os_write("mcc: trusted raw build\n")
        ...
        if (strcmp(first, "-compiler") == 0) {
            ...
            os_write("mcc: compiler raw build\n")
        ...
        os_write("use: mcc source.mc -o program\n")
        os_write("or:  mcc -aot source.mc -o program\n")
